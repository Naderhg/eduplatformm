...
import { teachers, platformCourses } from "@/lib/dashboard-data";
import { useState } from "react";

export const Route = createFileRoute("/dashboard/admin/teachers")({
  head: () => ({
    meta: [
      { title: "المدرسون | مدير النظام" },
      { name: "description", content: "كل المدرسين على المنصة وكورساتهم وعدد طلابهم وتقييماتهم." },
      { property: "og:title", content: "المدرسون | مدير النظام" },
      { property: "og:description", content: "متابعة أداء كل مدرس والكورسات التابعة له." },
    ],
  }),
