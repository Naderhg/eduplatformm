...
export const Route = createFileRoute("/dashboard/teacher/grading")({
  head: () => ({
    meta: [
      { title: "تصحيح على PDF | لوحة المدرس" },
      { name: "description", content: "تصحيح أوراق الطلاب بالكتابة مباشرة على ملف PDF داخل التطبيق دون تحميل." },
      { property: "og:title", content: "تصحيح على PDF | لوحة المدرس" },
      { property: "og:description", content: "أدوات تعليم وكتابة ودرجات فورية فوق ورقة الطالب." },
    ],
  }),
  component: GradingPage,
});

type Mark = { id: number; x: number; y: number; type: "correct" | "wrong" | "note"; text?: string | undefined };
