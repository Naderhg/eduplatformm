...
export const Route = createFileRoute("/dashboard/teacher/exams")({
  head: () => ({
    meta: [
      { title: "الامتحانات | لوحة المدرس" },
      { name: "description", content: "إنشاء الامتحانات ومتابعة التسليمات ونسب التصحيح." },
      { property: "og:title", content: "الامتحانات | لوحة المدرس" },
      { property: "og:description", content: "تابع التسليمات والتصحيح لكل امتحان في فصولك." },
    ],
  }),
  component: ExamsPage,
});
