...
import { platformCourses, teachers } from "@/lib/dashboard-data";
import { useState } from "react";

export const Route = createFileRoute("/dashboard/admin/courses")({
  head: () => ({
    meta: [
      { title: "إدارة الكورسات | مدير النظام" },
      { name: "description", content: "إنشاء وتعديل كورسات المنصة وربطها بالمدرسين والأسعار." },
      { property: "og:title", content: "إدارة الكورسات | مدير النظام" },
      { property: "og:description", content: "فورم إنشاء كورس جديد وقائمة بكل كورسات المنصة." },
    ],
  }),
