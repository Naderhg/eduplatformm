...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "إديوبورت | منصة تعليمية عربية لكورسات أونلاين" },
      {
        name: "description",
        content:
          "تعلّم بلا حدود مع إديوبورت: آلاف الكورسات في البرمجة والتصميم والتسويق بشهادات معتمدة ومدربين خبراء.",
      },
      { property: "og:title", content: "إديوبورت | منصة تعليمية عربية" },
      {
        property: "og:description",
        content: "كورسات أونلاين بشهادات معتمدة ومدربين خبراء في مكان واحد.",
      },
    ],
  }),
  component: Index,
    ...
    <div className="min-h-screen">
      ...
      <section className="mt-24 bg-muted/60 py-20">
        <div className="container-page">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold sm:text-4xl">ليه تختار إديوبورت؟</h2>
            <p className="mt-3 text-muted-foreground">
