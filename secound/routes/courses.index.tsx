...
export const Route = createFileRoute("/courses/")({
  head: () => ({
    meta: [
      { title: "كل الكورسات | إديوبورت" },
      {
        name: "description",
        content:
          "تصفح كورسات البرمجة والتصميم والتسويق والبيانات وفلترها حسب التصنيف والمستوى.",
      },
      { property: "og:title", content: "كل الكورسات | إديوبورت" },
      {
        property: "og:description",
        content: "تصفح وفلتر أفضل الكورسات العربية أونلاين.",
      },
    ],
  }),
