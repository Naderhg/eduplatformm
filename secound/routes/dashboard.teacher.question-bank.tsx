...
import { questionBanks } from "@/lib/dashboard-data";

export const Route = createFileRoute("/dashboard/teacher/question-bank")({
  head: () => ({
    meta: [
      { title: "بنوك الأسئلة | لوحة المدرس" },
      { name: "description", content: "نظّم أسئلتك في بنوك قابلة لإعادة الاستخدام في الامتحانات والكويزات." },
      { property: "og:title", content: "بنوك الأسئلة | لوحة المدرس" },
      { property: "og:description", content: "بنوك أسئلة مصنفة حسب المادة ونوع السؤال ومستوى الصعوبة." },
    ],
  }),
