...
export const Route = createFileRoute("/dashboard/teacher/parents")({
  head: () => ({
    meta: [
      { title: "إحصائيات أولياء الأمور | لوحة المدرس" },
      { name: "description", content: "تقارير أداء وحضور الطلاب المُرسلة لأولياء الأمور." },
      { property: "og:title", content: "إحصائيات أولياء الأمور | لوحة المدرس" },
      { property: "og:description", content: "أرسل تقارير أسبوعية تلقائية عن مستوى كل طالب." },
    ],
  }),
  component: ParentsStatsPage,
});

function ParentsStatsPage() {
  return (
    <>
      <PageHeader
